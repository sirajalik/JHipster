...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "FFBJavaRW@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "FFBJavaRW API";

        private String description = "FFBJavaRW API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "FFBJavaRW";
